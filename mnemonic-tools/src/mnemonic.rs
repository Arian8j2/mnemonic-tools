use crate::{u11::U11, BITS_PER_BYTE};
use sha2::Digest;
...
const ENTROPY_BYTES: usize = ENTROPY_BITS / BITS_PER_BYTE;

const HASH_BITS: usize = ENTROPY_BITS / 32;

const WORD_COUNT: usize = (ENTROPY_BITS + HASH_BITS) / U11::SIZE;
...
pub fn entropy_to_indices(entropy: &[u8]) -> Vec<U11> {
    ...
    entropy_with_checksum.push(calculate_entropy_checksum(entropy));
    U11::from_bytes(&entropy_with_checksum)
}

fn calculate_entropy_checksum(entropy: &[u8]) -> u8 {
